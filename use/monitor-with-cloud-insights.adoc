...
* link:../get-started/install-ads.html#install-the-monitoring-operator["Astra Data Store Monitoring Operator をインストールします"] これは、 Astra Data Store プレビューインストール手順の一部です。
